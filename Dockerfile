...
# docker build -t saju .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name saju saju
...
# Start server via Puma directly to avoid Thruster port 80 collisions
ENV PORT=3000
EXPOSE 3000
